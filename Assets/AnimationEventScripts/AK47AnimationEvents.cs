...
public class AK47AnimationEvents : MonoBehaviour
{
   ...
   void FireGun()
   {
       PlayerGunInteraction.FireGun(firepoint, 1, 0.1f, 100);
   ...
   void EmptyShell()
   {
      ...
      newShell.transform.localScale = new Vector3(3.5f, 3.5f, 3.5f);
